...
for row in df_trr_trrstatus_refresh['officer_appointed_date']:
    #print(type(row))
    if type(row) == pd._libs.tslibs.timestamps.Timestamp:
        df_trr_trrstatus_refresh['officer_appointed_date'] = df_trr_trrstatus_refresh['officer_appointed_date'].strftime('%Y-%m-%d')

#df_trr_trrstatus_refresh['officer_appointed_date'] = df_trr_trrstatus_refresh['officer_appointed_date'].dt.strftime('%Y-%m-%d')
#df_trr_trrstatus_refresh['officer_appointed_date'] = df_trr_trrstatus_refresh['officer_appointed_date'].dt.strftime('%Y-%m-%d') if not isinstance(x, pd.tslib.NaTType)]
#[x.strftime('%Y-%m-%d') for x in df_trr_trrstatus_refresh['officer_appointed_date'] if not isinstance(pd.NaT)]
