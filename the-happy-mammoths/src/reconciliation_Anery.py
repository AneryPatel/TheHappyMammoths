...
# --- Street ---
# df_trr_refresh = pd.read_sql_query("select * from trr_trr_refresh", con=conn)
# print(df_trr_refresh['street'].unique())
#
# df_trr = pd.read_sql_query("select * from trr_trr", con=conn)
# print(df_trr['street'].unique())
#
...
# --- Weapon Type ---trr_trr_subjectweapon.weapon_type
...
print(df_trr_subjectweapon['weapon_type'].unique())
# df_trr = pd.read_sql_query("select * from trr_trr", con=conn)
# df_trr = pd.read_sql_query("select * from trr_trr", con=conn)
print(df_trr_subjectweaponrefresh['weapon_type'].unique())
...
# ---- Indoor or Outdoor -----
# df_trr_refresh = pd.read_sql_query("select * from trr_trr_refresh", con=conn)
# print(df_trr_refresh['indoor_or_outdoor'].unique())
#
# df_trr = pd.read_sql_query("select * from trr_trr", con=conn)
# print(df_trr['indoor_or_outdoor'].unique())
#
...
# # df_trr_refresh['location'] = df_trr_refresh['location'].str.strip()
# df_trr_refresh['location'] = df_trr_refresh['location'].str.replace(' / ', '/')
# df_trr = pd.read_sql_query("select * from trr_trr", con=conn)
#
# # for val in df_trr_refresh['location']:
# x = df_trr['location'].unique()
# for i in x:
#     i = '"'+i+'"'
#     print(i)
# print('Compare karo')
