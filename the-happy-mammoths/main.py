...
subset_merged_refresh_unmatched = huge_merged_refresh[~huge_merged_refresh['id_y'].isna()]
subset_merged_status_unmatched = huge_merged_status[~huge_merged_status['id'].isna()]
